...
{{-- <div id="preloader">
    <div id="status">
        <div class="spinner-border text-primary avatar-sm p-5" role="status">
            <span class="visually-hidden">@lang('company.Loading...')</span>
            <img src="{{ asset('/build/images/favicon.png') }}" alt="Loading" class="spinner-image"
                style="object-fit: cover;"> <!-- Image inside spinner -->
        </div>
    </div>
</div> --}}
...
<div class="overlay" style="display: none;">
    <div class="spinner-border text-primary p-5 me-2" role="status">
        <span class="visually-hidden">@lang('company.Loading...')</span>
        <img src="{{ asset('/build/images/favicon.png') }}" alt="Loading" class="spinner-image"
            style="object-fit: cover;"> <!-- Image inside spinner -->
    </div>
    <div id="progress-container" class="text-center" style="display: none; margin-top: 10px;">
        <div class="progress" style="width: 200px; height: 30px;">
            <div id="progress-bar" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar"
                style="width: 0%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">0%
            </div>
        </div>
        <span class="text-white">@lang('company.Loading...')</span>
    </div>
</div>

{{-- @if (request()->segment(1) == 'general_settings') --}}
<!--customizer button  mdi-spin-->
