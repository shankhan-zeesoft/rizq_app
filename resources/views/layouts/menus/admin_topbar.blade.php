            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        @switch(app()->getLocale())
                            @case('ar')
                                <img src="{{ URL::asset('build/images/flags/sa.svg') }}" class="me-2 rounded" height="20"
                                    alt="عربي">
                            @break

                            @case('en')
                                <img src="{{ URL::asset('build/images/flags/us.svg') }}" class="me-2 rounded" height="20"
                                    alt="English">
                            @break
                        @endswitch
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <a href="{{ url('locale/ar') }}" class="dropdown-item notify-item language" data-lang="ae"
                            title="عربي">
                        ...
                        <!-- item-->
                        <a href="{{ url('locale/en') }}" class="dropdown-item notify-item language py-2"
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user"
                                src="@if (Auth::user()->photo != '') {{ URL::asset('images/' . Auth::user()->photo) }}@else{{ URL::asset('build/images/users/avatar-1.jpg') }} @endif"
                                alt="Header Avatar">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        {{-- <a class="dropdown-item" href="{{route('developer_faqs')}}"><i
                        ...
                        {{-- <a class="dropdown-item" href="{{route('developer_profile_lock')}}"><i
