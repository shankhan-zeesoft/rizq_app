            ...
            <div class="row justify-content-center">
                <div class="col-xl-4 text-center">
                    <div class="error-500 position-relative">
                        ...
                        <h1 class="title text-muted">255</h1>
                    </div>
                    <div>
                        <h4>@lang('frontend.Out of range Error!')</h4>
                        <p class="text-white w-75 mx-auto">@lang('frontend.The returned exit code is outside of the 0-255 range')</p>
                        {{-- <p>{{ $message }}</p>
